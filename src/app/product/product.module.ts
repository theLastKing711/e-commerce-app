...
import { ProductDetailsReviewStatsComponent } from './pages/product-details/components/product-details-review-stats/product-details-review-stats.component';
...
@NgModule({
  declarations: [
    ...
    ProductDetailsReviewStatsComponent
  ],
  imports: [
    CommonModule,
